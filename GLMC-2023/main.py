...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_log', type=str, default='GLMC-2023/output/')
    parser.add_argument('--root_model', type=str, default='GLMC-2023/output/')
    parser.add_argument('--store_name', type=str, default='GLMC-2023/output/')
    main()